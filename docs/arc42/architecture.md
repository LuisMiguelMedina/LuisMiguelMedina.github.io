...
| `/home/sam/comisiones` | sam | Comisiones | **implementado** | `SamCommissionsPage` (mockup de comisiones) | Página de Sam. El módulo `portal` "Comisiones" de su tarjeta enlaza aquí. Diseño de muestra; se modificará. |
